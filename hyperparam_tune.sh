...
#SBATCH -o /home/hice1/ktang86/scratch/cs7643/deepfake-detection/slurm_outs/%x_%j.out # Output file for stdout and stderr

mkdir -p /home/hice1/ktang86/scratch/cs7643/deepfake-detection/slurm_outs

module load anaconda3/2023.03

echo "Setting up environment paths..."
export CONDA_ENV_PATH="/home/hice1/ktang86/scratch/cs7643"
export PATH="$CONDA_ENV_PATH/bin:$PATH"
export PYTHONPATH="$CONDA_ENV_PATH/lib/python3.12/site-packages:$PYTHONPATH"

# Activate the Conda environment
echo "Activating Conda environment..."
source activate /home/hice1/ktang86/scratch/cs7643

cd /home/hice1/ktang86/scratch/cs7643/deepfake-detection
